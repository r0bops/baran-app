...
class MeshService : Service() {
    ...
    override fun onCreate() {
        ...
        val store = BaranApplication.instance.store
        val t = NearbyTransport(this, "Baran-" + store.deviceId().take(6), store)
        store.transport = t
    ...
    override fun onDestroy() {
        transport?.stop()
        BaranApplication.instance.store.transport = null
        scope.cancel()
        super.onDestroy()
    }
    ...
    private fun createNotificationChannel() {
        val channel = NotificationChannel(CHANNEL_ID, "Malla Baran", NotificationManager.IMPORTANCE_LOW).apply {
