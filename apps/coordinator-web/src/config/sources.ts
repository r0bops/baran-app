...
//
// Each entry declares how to FETCH an API, MAP its response to map points, and
// which FILTERS to expose. Add a new API by appending one object here; no
// component code changes. All overlay data is external/unsigned and is rendered
// as a layer separate from Baran's signed records.
// ─────────────────────────────────────────────────────────────────────────────
