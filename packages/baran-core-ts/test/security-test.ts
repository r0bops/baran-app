...
import type { BaranIdentity } from '../src/crypto.js';
...
function report(author: BaranIdentity, seq: number, over: Record<string, unknown> = {}): Record<string, unknown> {
...
function attest(claimer: BaranIdentity, seq: number, target: Record<string, unknown>, over: Record<string, unknown> = {}): Record<string, unknown> {
  const body: Record<string, unknown> = {
...
console.log('Baran adversarial security suite (core)\n');
