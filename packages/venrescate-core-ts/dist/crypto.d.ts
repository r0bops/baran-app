...
export declare function keyFromSeed(seedHex: string): VenRescateIdentity;
...
export declare function sign(recordNoSig: Record<string, unknown>, signer: VenRescateIdentity): SignResult;
export declare function verify(record: Record<string, unknown>, pubRaw: Uint8Array): boolean;
export declare function signPayload(payload: Record<string, unknown>, signer: VenRescateIdentity): string;
