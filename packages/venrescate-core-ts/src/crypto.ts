...
export interface VenRescateIdentity {
  seedHex: string;
...
export function keyFromSeed(seedHex: string): VenRescateIdentity {
...
export function sign(recordNoSig: Record<string, unknown>, signer: VenRescateIdentity): SignResult {
...
export function signPayload(payload: Record<string, unknown>, signer: VenRescateIdentity): string {
