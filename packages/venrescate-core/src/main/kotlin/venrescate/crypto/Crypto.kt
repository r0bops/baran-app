...
class VenRescateIdentity(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        if (other !is VenRescateIdentity) return false
...
object Crypto {
    ...
    fun keyFromSeed(seedHex: String): VenRescateIdentity {
        ...
        return VenRescateIdentity(seedHex, rawPub, pubB64u, deviceId, javaPriv, bcPriv)
    }
    ...
    fun sign(recordNoSig: Map<String, Any?>, signer: VenRescateIdentity): SignResult {
    ...
    fun signPayload(payload: Map<String, Any?>, signer: VenRescateIdentity): String {
